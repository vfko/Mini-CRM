...
define('TABLE_GDPR_CONDITIONS', 'gdpr_conditions');
define('TABLE_DISTRICT', 'district');
define('TABLE_REGION', 'region');
define('TABLE_TYPE_OF_RELATIONSHIP', 'type_of_relationship');
define('TABLE_TYPE_OF_CONTACT', 'type_of_contact');
define('TABLE_GDPR', 'gdpr');