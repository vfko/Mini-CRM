                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <input type="text" name="client_id" value="<?= $row['client_id'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Typ vztahu</label>
                                                                    <input type="text" name="type_of_contact_id" value="<?= (isset($template_data['type_of_contact'][$row['type_of_contact_id']])) ? $template_data['type_of_contact'][$row['type_of_contact_id']]['name'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Titul</label>
                                                                    <input type="text" name="title" value="<?= $row['title'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <input type="text" name="tel" value="<?= $row['tel'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Email</label>
                                                                    <input type="text" name="email" value="<?= $row['email'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Věk</label>
                                                                    <input type="text" name="age" value="<?= $row['age'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Domácnost</label>
                                                                    <input type="text" name="household_type_id" value="<?= (isset($template_data['household_type'][$row['household_type_id']])) ? $template_data['household_type'][$row['household_type_id']]['name'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Ulice</label>
                                                                    <input type="text" name="street" value="<?= $row['street'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Město</label>
                                                                    <input type="text" name="city" value="<?= $row['city'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">PSČ</label>
                                                                    <input type="text" name="psc" value="<?= $row['psc'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Okres</label>
                                                                    <input type="text" name="district_id" value="<?= (isset($template_data['district'][$row['district_id']])) ? $template_data['district'][$row['district_id']]['name'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Kraj</label>
                                                                    <input type="text" name="region_id" value="<?= (isset($template_data['region'][$row['region_id']])) ? $template_data['region'][$row['region_id']]['name'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Doporučitel</label>
                                                                    <input type="text" name="referrer_id" value="<?= $row['referrer_id'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Vztah k doporučiteli</label>
                                                                    <input type="text" name="type_of_relationship_id" value="<?= (isset($template_data['type_of_relationship'][$row['type_of_relationship_id']])) ? $template_data['type_of_relationship'][$row['type_of_relationship_id']]['name'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-12 form-group">
                                                                    <label class="control-label">Poznámka</label>
                                                                    <input type="text" name="note" value="<?= $row['note'] ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Operátor</label>
                                                                    <input type="text" name="operator_id" value="<?= (isset($template_data['operators'][$row['operator_id']])) ? $template_data['operators'][$row['operator_id']]['name'].' '.$template_data['operators'][$row['operator_id']]['surename'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Spánkový konzultant</label>
                                                                    <input type="text" name="seller_id" value="<?= (isset($template_data['sellers'][$row['seller_id']])) ? $template_data['sellers'][$row['seller_id']]['name'].' '.$template_data['sellers'][$row['seller_id']]['surename'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                                <!-- Text input-->
                                                                <div class="col-md-6 form-group">
                                                                    <label class="control-label">Provizní partner</label>
                                                                    <input type="text" name="commision_partner_id" value="<?= (isset($template_data['commision_partners'][$row['commision_partner_id']])) ? $template_data['commision_partners'][$row['commision_partner_id']]['name'].' '.$template_data['commision_partners'][$row['commision_partner_id']]['surename'] : 'Neuvedeno' ?>" class="form-control bg-light" readonly>
                                                                </div>
                                                        </div>
                                                        </form>
                                                    </div>
